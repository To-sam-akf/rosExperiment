...
(cl:defclass <CounterActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type ros_base_learning-msg:CounterGoal
    :initform (cl:make-instance 'ros_base_learning-msg:CounterGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <CounterActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CounterActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_base_learning-msg:<CounterActionGoal> is deprecated: use ros_base_learning-msg:CounterActionGoal instead.")))
...
(cl:defmethod goal_id-val ((m <CounterActionGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_base_learning-msg:goal_id-val is deprecated.  Use ros_base_learning-msg:goal_id instead.")
  (goal_id m))

(cl:ensure-generic-function 'goal-val :lambda-list '(m))
(cl:defmethod goal-val ((m <CounterActionGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_base_learning-msg:goal-val is deprecated.  Use ros_base_learning-msg:goal instead.")
  (goal m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CounterActionGoal>)))
  ...
  "ros_base_learning/CounterActionGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CounterActionGoal)))
  "Returns string type for a message object of type 'CounterActionGoal"
  "ros_base_learning/CounterActionGoal")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CounterActionGoal>)))
  ...
  "8a120ed5abfb0de35b383bc3a2fc85d8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CounterActionGoal)))
  "Returns md5sum for a message object of type 'CounterActionGoal"
  "8a120ed5abfb0de35b383bc3a2fc85d8")
